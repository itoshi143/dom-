...
def Main():
        os.system("clear")
        print(logo)
        print(" \033[1;35m[\033[1;32m1\033[1;35m] \033[1;33mID")
        ...
        if jubair in ["1","01"]:
            sexy()
        if jubair in ["2","02"]:
        	os.system('xdg-open https://www.facebook.com/profile.php?id=61554171762431')
        if jubair in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            pwx = [code+name+cod+love,cod+love,name+love,code+name+cod,'Philippines','Philippines']
...
#follow my facebook I'd https://www.facebook.com/profile.php?id=61554171762431
